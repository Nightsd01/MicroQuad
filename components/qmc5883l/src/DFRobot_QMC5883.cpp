...
void DFRobot_QMC5883::setDeclinationAngle(float declinationAngle) { this->ICdeclinationAngle = declinationAngle; }
...
int DFRobot_QMC5883::getICType(void) { return ICType; }
