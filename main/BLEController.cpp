...
void BLEController::beginBluetooth(void)
{
  ...
  _controlCharacteristic = _service->createCharacteristic(CONTROL_CHARACTERISTIC_UUID, BLECharacteristic::PROPERTY_READ | BLECharacteristic::PROPERTY_NOTIFY | BLECharacteristic::PROPERTY_WRITE_NR);
  _controlCharacteristic->setCallbacks(this);
  _controlCharacteristic->addDescriptor(new BLE2902());

  _telemetryCharacteristic = _service->createCharacteristic(TELEM_CHARACTERISTIC_UUID, BLECharacteristic::PROPERTY_READ | BLECharacteristic::PROPERTY_NOTIFY | BLECharacteristic::PROPERTY_WRITE_NR);
  ...
  _armCharacteristic = _service->createCharacteristic(ARM_CHARACTERISTIC_UUID, BLECharacteristic::PROPERTY_READ | BLECharacteristic::PROPERTY_NOTIFY | BLECharacteristic::PROPERTY_WRITE_NR);
  _armCharacteristic->setCallbacks(this);
  _armCharacteristic->addDescriptor(new BLE2902());

  _resetCharacteristic = _service->createCharacteristic(RESET_CHARACTERISTIC_UUID, BLECharacteristic::PROPERTY_READ | BLECharacteristic::PROPERTY_NOTIFY | BLECharacteristic::PROPERTY_WRITE_NR);
  _resetCharacteristic->setCallbacks(this);
  _resetCharacteristic->addDescriptor(new BLE2902());

  _motorDebugCharacteristic = _service->createCharacteristic(MOTOR_DEBUG_CHARACTERISTIC_UUID, BLECharacteristic::PROPERTY_READ | BLECharacteristic::PROPERTY_NOTIFY | BLECharacteristic::PROPERTY_WRITE_NR);
  _motorDebugCharacteristic->setCallbacks(this);
  _motorDebugCharacteristic->addDescriptor(new BLE2902());

  _calibrationCharacteristic = _service->createCharacteristic(CALIBRATION_CHARACTERISTIC_UUID, BLECharacteristic::PROPERTY_READ | BLECharacteristic::PROPERTY_NOTIFY | BLECharacteristic::PROPERTY_WRITE_NR);
  _calibrationCharacteristic->setCallbacks(this);
  _calibrationCharacteristic->addDescriptor(new BLE2902());

  _debugCharacteristic = _service->createCharacteristic(DEBUG_CHARACTERISTIC_UUID, BLECharacteristic::PROPERTY_READ | BLECharacteristic::PROPERTY_NOTIFY | BLECharacteristic::PROPERTY_WRITE_NR);
  ...
  // _deviceInfoService = _server->createService(DEVINFO_UUID);
  BLECharacteristic *manufacturerCharacteristic = _service->createCharacteristic(DEVINFO_MANUFACTURER_UUID, BLECharacteristic::PROPERTY_READ);
  manufacturerCharacteristic->setValue(DEVICE_MANUFACTURER);
  BLECharacteristic *deviceNameCharacteristic = _service->createCharacteristic(DEVINFO_NAME_UUID, BLECharacteristic::PROPERTY_READ);
  deviceNameCharacteristic->setValue(DEVICE_NAME);
  BLECharacteristic *deviceMacAddressCharacteristic = _service->createCharacteristic(DEVINFO_SERIAL_UUID, BLECharacteristic::PROPERTY_READ);
...
void BLEController::onWrite(BLECharacteristic *characteristic)
{
  ...
  else if (characteristic->getUUID().equals(_calibrationCharacteristic->getUUID()))
  {
    ...
    {
      const calibration_update_t calibrationUpdate = {
          .axis = axis,
